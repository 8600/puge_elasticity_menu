<template>
  <div class="elasticity-menu">
    <input type="checkbox" class="nav__cb" id="menu-cb">
    <div class="nav__content" :style="{width: data.length * 100 + 10}">
      <ul class="nav__items" :style="{width: data.length * 100 + 10}">
        <li class="nav__item" v-for="item in data" :key="item.id"> <span class="nav__item-text"> {{item.name}} </span> </li>
      </ul>
    </div>
